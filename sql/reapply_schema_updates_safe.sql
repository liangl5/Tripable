...
-- ============================================================
-- Add Splitwise-style settlement tracking for expenses
-- Source: sql/add_transaction_settlements.sql
-- ============================================================
...
DROP POLICY IF EXISTS "Creator or owner can update transaction" ON "Transaction";
